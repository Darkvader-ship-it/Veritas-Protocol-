/**
 * DreamDEX Event Contracts Indexer
 *
 * Indexes prediction data from DreamDEX Event Contracts V2 contract on Somnia
...
// Contract addresses
const CONTRACTS = {
  mainnet: '0xB52c5934113Af5c0Bb20eb3C72290C8215f755b9' as const,
  testnet: '0xB52c5934113Af5c0Bb20eb3C72290C8215f755b9' as const,
};
...
const publicClient = createPublicClient({
  chain: config.network === 'mainnet' ? somnia : somniaTestnet,
  transport: http(
    config.network === 'mainnet'
      ? (process.env.Somnia_RPC_URL || 'https://somnia-dataseed.somnia.org')
      : (process.env.Somnia_TESTNET_RPC_URL || 'https://data-seed-presomnia-1-s1.somnia.org:8545')
  ),
});
...
class DreamDEXIndexer {
  ...
  async initialize() {
    console.log('🚀 Initializing DreamDEX Event Contracts indexer...');
