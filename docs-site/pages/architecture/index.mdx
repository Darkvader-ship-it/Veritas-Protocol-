...
Veritas is a multi-layer decentralized application combining on-chain smart contracts with off-chain services.
...
- `hooks/` - Custom React hooks (useVeritas)
...
- `ScoreCalculator.sol` - VeritasScore algorithm
