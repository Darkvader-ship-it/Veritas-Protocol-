...
Veritas uses Supabase (PostgreSQL) for off-chain data storage.
...
('DreamDEX Event Contracts', 'dreamdex', 56, 'binary'),
...
SELECT
    b.market_id,
    b.position,
    b.amount / 1e18 as amount_stt,
    b.won,
    b.claimed_amount / 1e18 as payout_stt,
    b.bet_timestamp,
    p.name as platform
FROM bets b
