...
**Source:** `contracts/src/core/VeritasCore.sol`
...
|-----------|------|-------------|
| (payable) | - | Must send >= 0.0005 STT |

**Requirements:**
- User not already registered
- Value >= minting fee (0.0005 STT)
- Contract not paused
...
function importPredictions(
    ...
    emit VeritasScoreUpdated(msg.sender, newScore);
}
```
...
event VeritasScoreUpdated(address indexed user, uint256 newScore);
```
