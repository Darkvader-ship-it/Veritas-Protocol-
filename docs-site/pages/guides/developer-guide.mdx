...
This guide covers how to build on Veritas, integrate with the protocol, and contribute to development.
...
```solidity filename="test/VeritasCore.t.sol" copy
pragma solidity ^0.8.28;

import "forge-std/Test.sol";
import "../src/core/VeritasCore.sol";
...
import { VERITAS_CORE_ABI, CORE_ADDRESS } from '@/lib/contracts';
...
<Tabs items={['Development', 'Production (PM2)', 'Docker']}>
  <Tabs.Tab>
    ...
    npm run index:dreamdex:testnet   # Specific
    ```
  </Tabs.Tab>
  <Tabs.Tab>
    ```bash copy
