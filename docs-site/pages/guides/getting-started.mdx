...
This guide will help you set up Veritas for local development.
...
<FileTree>
  <FileTree.Folder name="veritas-mvp" defaultOpen>
    <FileTree.Folder name="contracts" defaultOpen>
      <FileTree.Folder name="src">
        <FileTree.Folder name="core">
          <FileTree.File name="VeritasCore.sol" />
...
SomniaSCAN_API_KEY=your_somniascan_api_key
```
...
3. Select your wallet and connect to STT Testnet

### Get Testnet STT

Get testnet STT from the [STT Faucet](https://testnet.sttchain.org/faucet-smart).

### Register as User

1. Navigate to Dashboard
2. Click "Register"
3. Confirm transaction (0.0005 STT fee)
4. Your soulbound NFT will be minted

### Import Predictions

1. Click "Import Predictions"
2. Select a platform (e.g., DreamDEX)
...
- [User Guide](/guides/user-guide) - Learn how to use Veritas
