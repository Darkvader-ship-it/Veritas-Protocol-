...
Veritas exposes REST APIs through Next.js API routes for accessing leaderboard data, market information, and copy trading operations.

**Base URL:** `https://veritas.xyz/api`
...
Returns ranked list of traders by VeritasScore.
...
<Tabs items={['Markets', 'Resolve']}>
  <Tabs.Tab>
    ...
    Returns active DreamDEX prediction rounds.
